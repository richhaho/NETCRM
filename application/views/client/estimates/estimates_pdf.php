    ...
    <tr>
        ...
        <td>
            <div id="invoice">
                ...
                <div class="date"><?= lang('estimate_date') ?>
                ...
                <div class="date"><?= lang('estimate_status') ?>: <?= lang($estimates_info->status) ?></div>
...
<table class="items" border="0" cellspacing="0" cellpadding="0" page-break-inside: auto;>
    ...
    <?php if ($estimates_info->discount_total > 0): ?>
        <tr class="total">
            <td colspan="3"></td>
            <td colspan="1"><?= lang('discount') ?>(<?php echo $estimates_info->discount_percent; ?>%)</td>
