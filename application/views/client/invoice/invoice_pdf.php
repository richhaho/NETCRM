    ...
    <tr>
        ...
        <td>
            <div id="invoice">
                ...
                <div class="date"><?= lang('invoice_date') ?>
                ...
                <?php } ?>
                <div class="date"><?= lang('payment_status') ?>: <?= $payment_status ?></div>
            </div>
        </td>
    </tr>
</table>
...
<table class="items" border="0" cellspacing="0" cellpadding="0" page-break-inside: auto;>
    ...
    <?php if ($invoice_info->discount_total > 0): ?>
        <tr class="total">
            <td colspan="3"></td>
            <td colspan="1"><?= lang('discount') ?>(<?php echo $invoice_info->discount_percent; ?>%)</td>
