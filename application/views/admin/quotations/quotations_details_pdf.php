    ...
    <table style="width: 100%; vertical-align: middle;">
        <tr>
            ...
            <td style="border: 0px;">
                ...
                <?= lang('country') . ': ' . config_item('company_country') . '-' . config_item('company_zip') ?>
        ...
        <td style="background-color: rgba(84, 73, 73, 0.12);">
            ...
            <ul class="list">
                ...
                if (!empty($client_info)) {
                    if ($client_info->select_type == 1) {
                        $client_type = '' . lang('person') . '';
                    } else {
                        $client_type = '' . lang('company') . '';
                    }
                } else {
                    $client_type = '';
                }
                ...
                <li class="list"><?= lang('client') ?><span
                        class="xright"><?= $quotations_info->name . ' ' . $client_type; ?></span>
                </li>
