...
//                    },
			        ...
			        eventSources: [
				        {
					        events: [
								...
								?>
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_payments->payment_date)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_payments->payment_date)) ?>',
				        ...
				        },
				        {
					        events: [<?php
								...
								?>
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_invoice->due_date)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_invoice->due_date)) ?>',
...

				        {
					        events: [<?php
								...
								?>
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_estimates->due_date)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_estimates->due_date)) ?>',
...

				        {
					        events: [<?php
								...
								?>
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_project->end_date)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_project->end_date)) ?>',
...

				        {
					        events: [<?php  if (config_item('milestone_on_calendar') == 'on') {
								...
								?>
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_milestone->end_date)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_milestone->end_date)) ?>',
...

				        {
					        events: [<?php
								...
								?>
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_task->due_date)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_task->due_date)) ?>',
...

				        {
					        events: [<?php if (config_item('bugs_on_calendar') == 'on') {
								...
								foreach ($bug_info as $v_bug) : ?>
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_bug->created_time)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_bug->created_time)) ?>',
				        ...
				        {
					        events: [<?php  if (config_item('opportunities_on_calendar') == 'on') {
								...
								foreach ($opportunity_info as $v_opportunity) : ?>
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_opportunity->close_date)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_opportunity->close_date)) ?>',
						        ...
						        },
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_opportunity->next_action_date)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_opportunity->next_action_date)) ?>',
							        color: '<?= config_item('opportunities_color') ?>',
							        url: '<?= base_url() ?>admin/opportunities/opportunity_details/<?= $v_opportunity->opportunities_id ?>'
						        },
								<?php endforeach;
				        ...
				        },
				        {
					        events: [<?php
								...
								?>
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_holiday->start_date)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_holiday->end_date)) ?>',
				        ...
				        },
				        {
					        events: [<?php if (config_item('goal_tracking_on_calendar') == 'on') {
								...
								if (!empty($all_goal_tracking)){foreach ($all_goal_tracking as $v_goal_tracking):?>
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_goal_tracking->end_date)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_goal_tracking->end_date)) ?>',
				        ...
				        },
				        {
					        events: [<?php  if (config_item('absent_on_calendar') == 'on') {
								...
								if (!empty($absent_user)) {?>
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_absent->date_in)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_absent->date_in)) ?>',
					        ...
					        events: [<?php if (config_item('on_leave_on_calendar') == 'on') {
								...
								$l_end_month = $l_emonth - 1; ?>
						        {
							        ...
							        start: '<?= strftime(config_item('date_format'), strtotime($v_leave->date_in)) ?>',
							        end: '<?= strftime(config_item('date_format'), strtotime($v_leave->date_in)) ?>',
    ...
    <script src="<?= base_url() ?>assets/plugins/fullcalendar/gcal.js"></script>
