                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7">
                                                    ...
                                                    if (!empty($invoice_info) && $invoice_info->recurring == 'Yes') {
                                                        $recur_start_date = strftime(config_item('date_format'), strtotime($invoice_info->recur_start_date));
                                                        $recur_end_date = strftime(config_item('date_format'), strtotime($invoice_info->recur_end_date));
                                                    } else {
                                                        $recur_start_date = strftime(config_item('date_format'));
                                                        $recur_end_date = strftime(config_item('date_format'));
                                                    }
                                                    ?>
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="due_date"
                                                           ...
                                                           if (!empty($invoice_info->due_date)) {
                                                               ...
                                                               echo strftime(strftime(config_item('date_format'), strtotime("+" . config_item('invoices_due_after') . " days")));
                                                           }
                                                           ?>"
                                                           data-date-format="<?= config_item('date_picker_format'); ?>">
                                                    <div class="input-group-addon">
