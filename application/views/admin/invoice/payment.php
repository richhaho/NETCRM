                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <select name="account_id" style="width:100%;" class="form-control select_box">
                                    <?php
                                    $account_info = $this->invoice_model->get_permission('tbl_accounts');
                            ...
                            <a target="_blank"
                               href="<?= base_url('admin/account/manage_account/new') ?>"><?= lang('add_new') ?></a>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <table class="table table-striped" cellspacing="0" width="100%">
                        ...
                        foreach ($all_payments_history as $v_payment_history) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <span><?= $payment_methods->method_name; ?></span>
                                </td>
                                <td>
