        ...
        <form id="time_validation"  data-parsley-validate="" novalidate=""
            ...
            <div class="form-group" id="border-none">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input type="text" name="date_in" class="form-control datepicker"
                                   value="<?= strftime(config_item('date_format')?>" required>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input type="text" name="clockin_time" class="form-control timepicker2"
                                   value="" required>
                            <div class="input-group-addon">
            ...
            <div class="form-group" id="border-none">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input type="text" name="clockout_time" class="form-control timepicker2"
                                   value="" required>
                            <div class="input-group-addon">
                                <a href="#"><i class="fa fa-clock-o"></i></a>
                            </div>
