                                                ...
                                                <div class="overlay">
                                                    <a data-toggle="modal"
                                                       ...
                                                       class="name"><i
                                                        ...
                                                        $fileName = (strlen($v_files->file_name) > 11) ? substr($v_files->file_name, 0, 8) . '...' : $v_files->file_name;
                                                        echo $fileName;
                                                        ?>
                                                    </a>
                                                    <p class="time m0 p0"> <?= strftime(config_item('date_format') . "<br/> h:m A", strtotime($files_info[$key]->upload_time)); ?></p>
                                                                    <span
