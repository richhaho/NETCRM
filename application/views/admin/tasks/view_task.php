                ...
                <div class="tab-content bg-white">
                    ...
                    <div class="tab-pane <?= $time_active == 2 ? 'active' : ''; ?>" id="contact">
                        <form role="form" enctype="multipart/form-data" id="form"
                            ...
                            <?php
                            if (!empty($tasks_timer_info)) {
                                $start_date = strftime(config_item('date_format'), $tasks_timer_info->start_time);
                                $start_time = date(strtotime(strftime(config_item('time_format'))), $tasks_timer_info->start_time);
                                $end_date = strftime(config_item('date_format'), $tasks_timer_info->end_time);
                                $end_time = date(strtotime(strftime(config_item('time_format'))), $tasks_timer_info->end_time);
                            } else {
                                $start_date = '';
                                $start_time = '';
                                $end_date = '';
