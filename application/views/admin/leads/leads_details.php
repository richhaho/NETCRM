                                    ...
                                    if (!empty($all_meetings_info)):
                                        foreach ($all_meetings_info as $v_mettings):
                                            ...
                                            <tr id="leads_meetings_<?= $leads_details->leads_id ?>">
                                                ...
                                                <td><?= strftime(config_item('date_format'), strtotime($v_mettings->start_date)) . ' | ' . display_time($v_mettings->start_date) ?></td>
                                                <td><?= strftime(config_item('date_format'), strtotime($v_mettings->end_date)) . ' | ' . display_time($v_mettings->end_date) ?></td>
                                                <td><?= $user->username ?></td>
                                                <td>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            ...
                                            if (!empty($mettings_info->start_date)) {
                                                echo strftime(config_item('date_format'), strftime($mettings_info->start_date));
                                            } else {
                                                echo strftime(config_item('date_format'));
                                            }
                                            ?>"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-group">
                                            <input type="text" required="" name="start_time"
                                                   class="form-control timepicker2" value="<?php
                                            if (!empty($mettings_info->start_date)) {
                                                echo display_time($mettings_info->start_date);
                                            }
                                            ?>">
                                            <div class="input-group-addon">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            ...
                                            if (!empty($mettings_info->end_date)) {
                                                echo strftime(config_item('date_format'), strftime($mettings_info->end_date));
                                            } else {
                                                echo strftime(config_item('date_format'));
                                            }
                                            ?>"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-group">
                                            <input type="text" required="" name="end_time"
                                                   class="form-control timepicker2" value="<?php
                                            if (!empty($mettings_info->end_date)) {
                                                echo display_time($mettings_info->end_date);
                                            }
                                            ?>">
                                            <div class="input-group-addon">
                                                <a href="#"><i class="fa fa-clock-o"></i></a>
                                                        ...
                                                        if (!empty($v_files_info)) {
                                                            foreach ($v_files_info as $v_files) {
                                                                ...
                                                                <tr class="file-item">
                                                                    ...
                                                                    <td class="col-date"><?= strftime(config_item('date_format') . "<br/> h:m A", strtotime($files_info[$key]->upload_time)); ?></td>
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="date"
                                                   ...
                                                   if (!empty($reminder_info->date)) {
                                                       ...
                                                       echo strftime(config_item('date_format', 'time_format'));
                                                   }
                                                   ?>"
                                                   data-date-min-date="<?= strftime(config_item('date_format')); ?>">
                                            <div class="input-group-addon">
                                                <a href="#"><i class="fa fa-calendar"></i></a>
                                            </div>
                                        </div>
                    ...
                    function init_datepicker() {
                        ...
                        $.each(datetimepickers, function () {
                            opt_time = {
                                lazyInit: true,
                                scrollInput: false,
                                format: strftime(config_item('date_format', 'time_format')),
                            };

                            opt_time.formatTime = strtotime(strftime(config_item('time_format')));;
