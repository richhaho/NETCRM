        ...
        <form action="<?php echo base_url() ?>admin/settings/save_theme" enctype="multipart/form-data"
            ...
            <div class="panel panel-custom">
                ...
                <div class="panel-body">
	                ...
	                <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('app_logo') ?></label>
                        <div class="col-lg-7">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 210px;">
                                    <?php if (config_item('app_logo') != '') : ?>
	                                    <img src="<?php echo base_url() . config_item('app_logo'); ?>">
									<?php else: ?>
	                                    <img src="http://placehold.it/350x260" alt="Please Connect Your Internet">
									<?php endif; ?>
                                </div>
                                ...
                                <div>
                                    <span class="btn btn-default btn-file">
                                        <span class="fileinput-new">
                                            <input type="file" name="app_logo" value="upload"
                                                   data-buttonText="<?= lang('choose_file') ?>" id="myImg"/>
                                            <span class="fileinput-exists"><?= lang('change') ?></span>
                                        </span>
                                        <a href="#" class="btn btn-default fileinput-exists"
