                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    if (!empty($opportunity_info)) {
                                        $close_date = strftime(config_item('date_format'), strtotime($opportunity_info->close_date));
                                        $next_action_date = strftime(config_item('date_format'), strtotime($opportunity_info->next_action_date));
                                    } else {
                                        $close_date = strftime(config_item('date_format'));
                                        $next_action_date = strftime(config_item('date_format'));
                                    }
                                    ?>
                                    <div class="col-lg-4">
                            ...
                            <div class="form-group" id="border-none">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <a target="_blank"
                                       href="<?= base_url('admin/settings/opportunities_state_reason') ?>"><?= lang('new') ?></a>
                                </div>
                            </div>
