                                        ...
                                        if (!empty($all_mettings_info)):
                                            foreach ($all_mettings_info as $v_mettings):
                                                ...
                                                <tr id="table-meeting-<?= $v_mettings->mettings_id ?>">
                                                    ...
                                                    <td><?= strftime(config_item('date_format'), strtotime($v_mettings->start_date)) . '<span style="color:#3c8dbc"> at </span>' . display_time($v_mettings->start_date) ?></td>
                                                    <td><?= strftime(config_item('date_format'), strtotime($v_mettings->end_date)) . '<span style="color:#3c8dbc"> at </span>' . display_time($v_mettings->end_date) ?></td>
                                                    <td><?= $user->username ?></td>
                                                    <td>
