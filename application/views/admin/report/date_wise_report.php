                ...
                <div class="panel-title">
                    ...
                    if (!empty($all_transaction_info)):
                        ...
                        <div class="pull-right hidden-print">
                            <a href="<?php echo base_url() ?>admin/report/date_wise_report_pdf/<?= strftime(config_item('date_format'), strtotime($start_date)) . '/' . strftime(config_item('date_format'), strtotime($end_date)) ?>"
