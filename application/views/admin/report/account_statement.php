                ...
                <div class="panel-title">
                    ...
                    if (!empty($all_transaction_info)):
                        ...
                        <div class="pull-right hidden-print">
                            <a href="<?php echo base_url() ?>admin/report/account_statement_pdf/<?= $account_id . '/' . strftime(config_item('date_format'), strtotime($start_date)) . '/' . strftime(config_item('date_format'), strtotime($end_date)) . '/' . $transaction_type ?>"
