        ...
        <div class="col-md-4">
            <div class="row row-table pv-lg">
                ...
                <div class="col-xs-6">
                    ...
                    <p class="m0">
                        <small><?= lang('completed_achievements') ?></small>
                    </p>
                </div>
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a style="background-color: #1797be;color: #ffffff"
                       href="<?= base_url() ?>admin/client/import"><?= lang('import_client') ?></a>
                </li>
            </ul>
                                    ...
                                    <div class="nav-tabs-custom">
                                        ...
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li><a href="#contact_compnay"
                                                   data-toggle="tab"><?= lang('client_contact_details') ?></a>
                                            </li>
                                        ...
                                        <div class="tab-content bg-white">
                                            ...
                                            <div class="chart tab-pane active" id="general_compnay">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <a target="_blank"
                                                           href="<?= base_url() ?>admin/settings/customer_group"><?= lang('new_customer_group') ?></a>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label
