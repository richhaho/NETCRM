            ...
            <div class="row-table row-flush">
                ...
                <div class="col-xs-8">
                    <div class="text-center">
                        <h4 class="mb-sm">
                            <?= $perc_paid ?>%</h4>
                        <p class="mb0 text-muted"><?= lang('paid_percentage') ?></p>
                        <a href="<?= base_url() ?>admin/invoice/all_payments"
                           class="small-box-footer"><?= lang('more_info') ?>
                            <i
                                class="fa fa-arrow-circle-right"></i></a>
    ...
    <div class="col-sm-3">
        <ul class="nav nav-pills nav-stacked navbar-custom-nav">
            ...
            <li class="<?= $url == 'notes' ? 'active' : '' ?>"><a href="#notes" data-toggle="tab"
                                                                  aria-expanded="false"><?= lang('notes') ?><strong
                        class="pull-right"><?= (!empty($client_notes) ? count($client_notes) : null) ?></strong></a>
            </li>
            <li class="<?= $url == 'invoice' ? 'active' : '' ?>"><a href="#invoices" data-toggle="tab"
                                                                    aria-expanded="false"><?= lang('invoices') ?>
                    <strong
                        class="pull-right"><?= (!empty($client_invoices) ? count($client_invoices) : null) ?></strong></a>
            </li>
            <li class="<?= $url == 'payment' ? 'active' : '' ?>"><a href="#payments" data-toggle="tab"
                                                                    aria-expanded="false"><?= lang('payments') ?><strong
                                ...
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        ...
                                        <a href="<?= base_url() ?>admin/client/client_details/<?= $client_details->client_id ?>"
                                           class="btn-sm pull-right"><?= lang('return_details') ?> </a>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <div class="col-sm-8">
