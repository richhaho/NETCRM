...
class Peeker_db_methods
{
    ...
    public function get_email_as_array()
    {
        ...
        $email_strings_array['date_sent_stamp'] = strftime(config_item('date_format', 'time_format'), $this->that->get_udate());
        ...
        $email_strings_array['date_received_stamp'] = strftime(config_item('date_format', 'time_format'));
