    ...
    <div class="container" style="width:80%">
        <section class="panel panel-default bg-white m-t-lg">
            <header class="panel-heading text-center">
                <strong>NETCRM</strong>
            </header>
            <div class="panel-body wrapper-lg">
                <?php
                $step1 = $step2 = $step3 = '';
                $badge1 = $badge2 = $badge3 = 'badge';
                if (isset($step)) {
                    switch ($step) {
                        case '2':
                            $step2 = 'active';
                ...
                <div class="panel panel-default wizard">
                    <div class="wizard-steps clearfix" id="form-wizard">
                        <ul class="steps">
                            ...
                            <li class="<?= $step2 ?>"><span class="<?= $badge2 ?>">2</span> Database Settings
                            </li>
                            <li class="<?= $step3 ?>"><span class="<?= $badge3 ?>">3</span> Basic Settings</li>
                        </ul>
                    </div>
                        ...
                        <?php if ($step == 3) { ?>
                            <div class="step-pane <?= $step3 ?>" id="step3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="email" class="form-control" placeholder="admin@groupnet.es"
                                               name="admin_email">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="form-control" placeholder="GROUPNET"
                                               name="company_name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="email" class="form-control" placeholder="info@groupnet.es"
                                               name="company_email">
                                    </div>
                                </div>
                                <div class="form-group">
