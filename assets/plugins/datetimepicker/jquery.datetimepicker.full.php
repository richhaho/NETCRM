<script type="text/javascript">
    ...
    (function (factory) {
        ...
        var default_options = {
            ...
            format: 'Y/m/d H:i',
            formatTime: strtotime(strftime(config_item('time_format')));,
            formatDate: 'Y/m/d',
            ...
            defaultTime: false,	// use formatTime format (ex. '10:00' for formatTime:	strtotime(strftime(config_item('time_format')));)
